  ...
  group('UserData', () {
    group("PatientData", () {
      ...
      test("Check Patient Mail for non-empty database", () async {
        ...
        final mockData = <String, String>{"name": "John", "surname": "Doe"};
        await instance
            .collection('patients')
            .doc("patient1@bth.se")
            .set(mockData);
      ...
      test("Check Patient Mail after adding", () async {
        ...
        final mockData = <String, String>{"name": "John", "surname": "Doe"};
        await instance.collection('patients').doc(email).set(mockData);
    ...
    group("DoctorData", () {
      ...
      test("Check if Doctor exists after adding by email address", () async {
        ...
        await instance.collection('doctors').doc(email).set(mockData);
